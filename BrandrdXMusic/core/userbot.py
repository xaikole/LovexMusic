...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Ofcbotxaiko")
                await self.one.join_chat("ofcbotxaiko")
                await self.one.join_chat("anons_chat_group")
                await self.one.join_chat("anons_chat_group")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ofcbotxaoko")
                await self.two.join_chat("ofcbotxaiko")
                await self.two.join_chat("anons_chat_grpup")
                await self.two.join_chat("anons_chat_group")
            except:
                pass
            assistants.append(2)
            try:
